...
* 해당 프로그램은 자막을 편리하게 다운받기 위해 제작되었으나, 자막을 만들어 주시는 분들의 블로그 활동에도 <br> 관심과 응원 부탁드립니다.

* 다운로드 링크가 URL로 제공되지 않거나 CloudFlare Captcha 인증이 필요한 블로그는 지원되지 않습니다.

* 이미 다운로드된 자료는 다시 요청하지 않고 자동으로 건너뜁니다.
